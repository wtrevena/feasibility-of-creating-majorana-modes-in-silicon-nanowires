...
\author{W.~T.~Trevena}
\date{June 2026 --- draft v2 (revised after external review)}
\begin{document}
\maketitle
...
does), 34--55$\ueV$ metallization-renormalized. The hole route is therefore a
...
quasiparticle weight $Z$ (Supplement S6) --- we do not solve the dynamical
self-energy problem, and the renormalized numbers bound the direction of the
omitted physics. All caricature choices (GL/Zeeman-linear parent gaps, iid
...
verified numerically to $3\times10^{-10}\ueV$ for valley-scalar and
phase-locked Dresselhaus SOC alike): smooth interfaces are benign, and valley
...
Field-orientation maps [Fig.~\ref{fig:orient}] under both $g$-tensors and two parents
give the design rules: (i)~an \textbf{Al film} parent is locked to in-plane fields but
strong---34--55$\ueV$ metallization-renormalized---\emph{if} a hard-gap Al/Si-hole
...
point is 11.0$\ueV$ bare / 10.1 renormalized on the finest optimizer grids,
Supplement S5, and moves over 8--11$\ueV$ under $\pm$20\% parent-model
...
numbers inherit the stated caricatures (single channel, hard-wall LK, parent-gap
models, iid disorder); their domains of validity and the sensitivity of every
...
families are documented in \texttt{README.md} and Supplement S4/S8. An archival
snapshot (repository URL, commit hash, and DOI) will be deposited on Zenodo at
submission. [Zenodo DOI: to be inserted at submission.]
...
Three internal numerical-review rounds and one round of revisions in response
to external review are documented, with their corrections, in the repository
log. AI-assisted review supplements but does not substitute for the
reproducibility materials above; all claims trace to committed, seeded code.
